...
class Box2DSimRatEnv(gym.Env):
    ...
    def set_action(self, action):
        ...
        self.oscillator = np.sin(6*2*np.pi*self.clock*self.dt_clock)
        #angles = np.zeros(self.num_joints)
        #self.angles[:int(whiskers_angles/2)] = - self.angles[:int(whiskers_angles/2)]
        ...
        """
        self.d_angles[:int(whiskers_angles/2)] = \
                - ( action[:int(whiskers_angles/2)]*self.oscillator \
                + action[whiskers_angles:(2*whiskers_angles-int(whiskers_angles/2))] ) \
                - self.angles[:int(whiskers_angles/2)]
        self.angles[:int(whiskers_angles/2)] += self.d_angles*self.dt_clock
        self.d_angles[int(whiskers_angles/2):whiskers_angles] = \
                + action[int(whiskers_angles/2):whiskers_angles]*self.oscillator  \
                + action[(whiskers_angles+int(whiskers_angles/2)):(2*whiskers_angles)] \
                - self.angles[int(whiskers_angles/2):whiskers_angles]
        self.angles[int(whiskers_angles/2):whiskers_angles] +=
        """
